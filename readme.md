...
Expands the opponent range into legal physical combinations

Removes blocked combinations

Samples an opponent hand

Removes all known cards from the deck

Completes the board

Evaluates the showdown

Records a win, tie, or loss
